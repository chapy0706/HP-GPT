...
const modalSteps = [
  ...
  {
    text: `なぜ、神経整体なのか？
      <br>いままでしてきたことを、見直してるときに「神経整体」という施術に目が止まった。「これだ！」と、直観し、体験させてもらうことに。
      <br>「？？？」正直、理解できなかったが、からだが感じている。 「やってみよう！」 最初は半信半疑だったが、変化を感じ、喜んでくれる、お客様。
      <br>こちらもびっくりするような事も目の当たりにした。
      <br>今までと正反対。押したり揉んだりこちらが狙うんじゃなくて、触れてるか、触れていないか分からないくらいでからだが勝手に動いて教えてくれる、
      <br>お互い神経を感じあうことで相乗効果。こんな施術があったなんて。求めていたものはこれかもしれない。こちらがなんとかするんじゃなくて、一緒に元にもどしていく施術。
      <br>神経整体と一緒に、さらなる可能性を広げていきたい。
      <br>あなたは、今、どんな状態ですか？<br>そして、何かを感じました？
      <br>よかったら、おしえてください！一緒に、元に戻していけたらうれしいです。
      <br>小さなことでも構いません、お待ちしております。`,
    buttons: [
